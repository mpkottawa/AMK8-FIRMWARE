 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //MK
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 50  //MK
...
//
#define NUM_Z_STEPPER_DRIVERS 2   //MK (1-4) Z options change based on how many
...
#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  //MK (mm) Backoff from endstops after homing

#define QUICK_HOME  //MK                        // If G28 contains XY do a diagonal move first
 ...
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 8000
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define BOOTSCREEN_TIMEOUT 5000 //mk 4000       // (ms) Total Duration to display the boot screen(s)
#endif
   ...
   */
  #define SD_REPRINT_LAST_SELECTED_FILE   //MK
  ...
  //#define BINARY_FILE_TRANSFER  //MK
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        28  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY       3500  // (ms) Delay for the filament to cool after retract.
