...
#define STRING_CONFIG_H_AUTHOR "Matthew P. Keith" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AMK8 THE CRKT"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  32.95
    #define DEFAULT_Ki   4.98
    #define DEFAULT_Kd 54.47
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 38.95
  #define DEFAULT_bedKi 1.99
  #define DEFAULT_bedKd 508.60
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 800, 800, 3200, 2259 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 450, 450, 25, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 24, 6, -0.9 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 10)  // X point for Z homing
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 30), (Y_MIN_POS + 30), 10 }
