...
#define STRING_CONFIG_H_AUTHOR "Matt Keith" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AMK8"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki   5.54
    #define DEFAULT_Kd 34.71
  #endif
#endif // PIDTEMP
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600 H"
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  //mk
